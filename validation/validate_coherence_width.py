...
def coherence_width_spherical_downlink(channel: DownlinkChannel) -> float:
    ...
    integrand = (
        ...
        * scale
        * ((higher_alt - h) / (higher_alt - lower_alt)) ** (5 / 3)
    )
...
def coherence_width_spherical_uplink(channel: UplinkChannel) -> float:
    """Compute coherence width of spherical wave for an uplink channel [Andrews/Phillips, 2005].
    ...
    integrand = (
        lambda h: channel.atmospheric_channel.cn2_profile(h)
        * scale
        * ((h - lower_alt) / (higher_alt - lower_alt)) ** (5 / 3)
    )
...
if __name__ == "__main__":
    ...
    coherence_width_general_downlink_plane_list = []
    coherence_width_general_downlink_spherical_list = []
    coherence_width_general_downlink_gaussian_list = []
    coherence_width_downlink_plane_list = []
    coherence_width_downlink_spherical_list = []

    coherence_width_general_uplink_plane_list = []
    coherence_width_general_uplink_spherical_list = []
    coherence_width_general_uplink_gaussian_list = []
    coherence_width_uplink_plane_list = []
    coherence_width_uplink_spherical_list = []

    for i in range(len(altitude_vector)):

        coherence_width_general_downlink_plane = (
            downlink_channel.compute_coherence_width(wave_type="plane")
        )
        coherence_width_general_downlink_spherical = (
            downlink_channel.compute_coherence_width(wave_type="spherical")
        )
        coherence_width_general_downlink_gaussian = (
            downlink_channel.compute_coherence_width(wave_type="gaussian")
        )
        coherence_width_downlink_plane = coherence_width_plane_downlink(
            downlink_channel
        )
        coherence_width_downlink_spherical = coherence_width_spherical_downlink(
            downlink_channel
        )
        coherence_width_general_downlink_plane_list.append(
            coherence_width_general_downlink_plane
        )
        coherence_width_general_downlink_spherical_list.append(
            coherence_width_general_downlink_spherical
        )
        coherence_width_general_downlink_gaussian_list.append(
            coherence_width_general_downlink_gaussian
        )
        coherence_width_downlink_plane_list.append(coherence_width_downlink_plane)
        coherence_width_downlink_spherical_list.append(
            coherence_width_downlink_spherical
        )

        coherence_width_general_uplink_plane = uplink_channel.compute_coherence_width(
            wave_type="plane"
        )
        coherence_width_general_uplink_spherical = (
            uplink_channel.compute_coherence_width(wave_type="spherical")
        )
        coherence_width_general_uplink_gaussian = (
            uplink_channel.compute_coherence_width(wave_type="gaussian")
        )
        coherence_width_uplink_plane = coherence_width_plane_downlink(uplink_channel)
        coherence_width_uplink_spherical = coherence_width_spherical_uplink(
            uplink_channel
        )
        coherence_width_general_uplink_plane_list.append(
            coherence_width_general_uplink_plane
        )
        coherence_width_general_uplink_spherical_list.append(
            coherence_width_general_uplink_spherical
        )
        coherence_width_general_uplink_gaussian_list.append(
            coherence_width_general_uplink_gaussian
        )
        coherence_width_uplink_plane_list.append(coherence_width_uplink_plane)
        coherence_width_uplink_spherical_list.append(coherence_width_uplink_spherical)
...
plt.xlabel("Platform altitude (km)")
plt.ylabel("Coherence Width (m)")
plt.title("Coherence Width in Uplink Channel")
plt.legend()
plt.grid()
plt.tight_layout()
