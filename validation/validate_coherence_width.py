...
def downlink_coherence_width_plane_reference(channel: FreeSpaceChannel) -> float:
...
def downlink_coherence_width_spherical_reference(channel: FreeSpaceChannel) -> float:
    receiver_alt = channel.receiver_altitude_m
    transmitter_alt = channel.transmitter_altitude_m
    k = 2 * np.pi / channel.transmitter_station.transmitter.wavelength
...
if __name__ == "__main__":
    ...
    for i in range(len(altitude_vector)):
        ...
        coherence_width_general_gaussian = free_space_channel.compute_coherence_width(
            link_type="downlink", 
            wave_type="gaussian")
        coherence_width_plane = downlink_coherence_width_plane_reference(free_space_channel)
        coherence_width_spherical = downlink_coherence_width_spherical_reference(free_space_channel)
...
plt.plot(altitude_vector, conherence_width_plane_list, "o", label="Plane Wave (Reference)")
plt.plot(altitude_vector, conherence_width_spherical_list, "o", label="Spherical Wave (Reference)")
